...
export const translations: Record<Locale, Dict> = {
  sk: {
    ...
    "hero.subhead":
      "Olympionička · slovenská reprezentantka · medailistka z Majstrovstiev Európy",
    "hero.cta.story": "Objavte môj príbeh",
    ...
    "journey.title": "Od Bobrovca po svet",
    "journey.lead":
    ...
    "partners.title": "Spoločne k cieľu",
    "partners.lead":
      "Dukla Banská Bystrica, Slovenský atletický zväz a partneri, ktorí sa zo mňa stávajú spojencami každý deň.",
  ...
  en: {
    ...
    "hero.cta.story": "Discover My Story",
    ...
    "journey.title": "From Bobrovec to the world",
    "journey.lead":
    ...
    "partners.title": "Together to the finish line",
    "partners.lead":
